...
$(document).ready(function () {
  ...
  if ($navItems.length > maxVisible) {
    ...
    var $toggleBtn = $('<button id="toggleMore" class="category-more"><span></span>Xem thêm</button>');
    ...
    $toggleBtn.on('click', function () {
      ...
      if (isExpanded) {
        $(this).text('Xem thêm').removeClass('action'); // giữ span nếu cần thêm nội dung, ví dụ icon
